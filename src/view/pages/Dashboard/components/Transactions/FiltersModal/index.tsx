...
export const FiltersModal = ({ open, onClose, onApplyFilters }: FiltersModalProps) => {
	const { selectBankAccountId, selectedYear, accounts, handleSelectBankAccount, handleChangeYear } =
