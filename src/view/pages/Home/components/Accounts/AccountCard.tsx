...
import { useDashboard } from "../HomeContext/useHome";
import { ListBankAccountsResponse } from "../../../../../app/services/bankAccounts/list";

type AccountCardProps = {
	data: ListBankAccountsResponse["bankAccounts"][0];
};
